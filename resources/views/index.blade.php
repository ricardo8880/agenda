...
<body id="body-home-azul">
        ...
        <div class="box-home-mensagens">
            ...
            <div class="pt-5">
                <div class="bg-light p-1 py-2 shadow rounded mx-4 row m-0 box-agenda">
                    ...
                    <a href="#" class="col-2 m-0 icone-mais" item-id="{{$t->id}}"><img src="/img/icone-mais.png"
                            alt="/img/icone-mais.png" class="mt-2"></a>
                </div>
            </div>
            @endforeach
        </div>
    ...
    <div class="shadow text-center bg-light mt-5">
        <a href="/adicionar_tarefa">
            <p class="p-4 lead m-0" style="color: #5566f7"><span><img src="/img/icone-mais.png"
                        alt="/img/icone-mais.png"></span><strong>Adicionar uma tarefa pendente</strong></p>
        </a>
    </div>
